...
namespace ColorFusion
{
    public partial class Sales : Form
    {
        ...
        {
            salesChart.DataSource = InventoryDL.ProductsList1;
            salesChart.Series["Products"].XValueMember = "Name1";
            salesChart.Series["Products"].XValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.String;
            salesChart.Series["Products"].YValueMembers = "SoldCount1";
            salesChart.Series["Products"].YValueType = System.Windows.Forms.DataVisualization.Charting.ChartValueType.Int32;
        }
